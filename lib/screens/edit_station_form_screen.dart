          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                validator: (v) =>
                    (v == null || v.trim().isEmpty) ? 'Please enter station name' : null,
              ),
              const SizedBox(height: 12),
              TextFormField(
                controller: _zoneCtl,
                ...
                validator: (v) => (v == null || v.trim().isEmpty) ? 'Please enter zone' : null,
              ),
              const SizedBox(height: 12),
              TextFormField(
                ...
                validator: (v) =>
                    (v == null || v.trim().isEmpty) ? 'Please enter province' : null,
              ),
